class bomb {
  ...
  void renderBomb() {
    ...
    {
      image(bomb1, x+6, y-36);
    } else if (counter>10 && counter<=20) 
    {
      image(bomb2, x+6, y-36);
    } else if (counter>20 && counter<=30)
    {
      image(bomb3, x+6, y-36);
    } else if (counter>30 && counter<=40)
    {
      image(bomb4, x+6, y-36);
    } else if (counter>40 && counter<=50) 
    {
      image(bomb5, x+6, y-36);
    } else if (counter>50 && counter<=60)
    {
      image(bomb6, x+6, y-36);
    } else if (counter>60 && counter<=70) 
    {
      image(bomb7, x+6, y-36);
    } else if (counter>70 && counter<=80)
    {
      image(bomb8, x+6, y-36);
    } else if (counter>80 && counter<=90) 
    {
      image(bomb9, x+6, y-36);
    } else
    {
    }
    counter++;
